 ...
 *
 */
package com.hust.weixin.hibernate.dao;

import com.hust.weixin.hibernate.model.Pager;
import com.hust.weixin.hibernate.model.SystemRequest;
import com.hust.weixin.hibernate.model.SystemRequestHolder;
...
//	}
    ...
    public <N extends Object> List<N> listBySql(String sql, Map<String, Object> alias, Class<?> clz, boolean hasEntity, Object... args) {
        sql = initSort(sql);
    ...
    public <N extends Object> Pager<N> findBySql(String sql, Map<String, Object> alias, Class<?> clz, boolean hasEntity, Object... args) {
        sql = initSort(sql);
